...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header text-center">
            <h6 class="text-primary font-weight-bold m-0" style="font-size: 25px;">Tutores pendientes</h6>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-md-right d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-sm-start justify-content-md-end justify-content-lg-end justify-content-xl-end dataTables_filter" id="dataTable_filter">
                        <form class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center align-items-xl-center" id="buscadorTutoresPendientes">
                            <input class="form-control" type="text" placeholder="Buscar nombre" style="color: rgb(0,0,0);" id="buscarTutoresPendientes">
            ...
            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info" style="font-size: 18px;">
                <table class="table dataTable my-0" id="dataTable">
                    <thead style="color: #267d24;">
                        <tr>
                            <th class="text-primary" style="font-size: 18px;">Nombre del tutor</th>
                    ...
                    <tbody style="color: rgb(0,0,0);">
                        @foreach($usuarios as $usuario)
                            <tr>
                                ...
                                <td>{{ $usuario->email }}</td>
                                <td>
                                    <a class="btn btn-primary" role="button" href="{{ route('admin.agregar-tutor', ['idUsuario' => $usuario->id, 'estatus' => 1]) }}" style="margin-right: 10px;">Activar</a>
                                    <a class="btn btn-danger btn-estado" role="button" href="{{ route('admin.agregar-tutor', ['idUsuario' => $usuario->id, 'estatus' => 0]) }}">Eliminar</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot style="color: #267d24;">
                        <tr>
                            <td><strong class="text-primary">Nombre del tutor</strong>&nbsp;</td>
