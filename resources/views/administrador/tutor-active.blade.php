...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header text-center">
            <h6 class="text-primary font-weight-bold m-0" style="font-size: 25px;">Tutores activos</h6>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-md-right d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-sm-start justify-content-md-end justify-content-lg-end justify-content-xl-end dataTables_filter" id="dataTable_filter">
                        <form class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center align-items-xl-center" id="buscadorTutoresActivos">
                            <input class="form-control" type="text" placeholder="Buscar nombre" style="color: rgb(0,0,0);" id="buscarTutoresActivos">
                    ...
                    <tbody style="color: rgb(0,0,0);">
                        @foreach($tutores as $tutor)
                            <tr>
                                ...
                                <td>{{ $tutor->email }}</td>
                                <td><a class="btn btn-danger btn-estado" role="button" href="{{ route('admin.desactivar-tutor', ['idUsuario' => $tutor->id]) }}">Eliminar</a></td>
                            </tr>
                        @endforeach
                    </tbody>
