...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header text-center">
            <h6 class="text-primary font-weight-bold m-0" style="font-size: 25px;">Modificar actividad para tutorado</h6>
        </div>
        <div class="card-body">
            <div class="row d-flex justify-content-center">
                <div class="col col-create-activity">
                    <div class="p-5-create-activity-tutor">
                        <form class="user" method="POST" action="{{ route('admin.actualizar-actividad-tutorado', ['idActividad' => $actividadTutorado->id, 'idPregunta' => $pregunta->id]) }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <select class="form-control" id="gradoEscolar" name="gradoEscolar" style="font-size: 18px;border-radius: 10rem;color: rgb(0,0,0);max-width: 70%;" required autofocus>
                                        <optgroup label="Grado escolar">
                                            @foreach($gradosEscolares as $gradoEscolar)
                                                @if($gradoEscolar->id == $actividadTutorado->id_gradoEscolar)
                            ...
                            <div class="form-group">
                                <div class="col" style="padding: 0px;">
                                    <input class="form-control form-control-user @error('semana') is-invalid @enderror" type="number" style="color: rgb(0,0,0);font-size: 18px; max-width: 210px;" placeholder="Número de semana" id="semana" name="semana" min="1" max="25" value="{{ $actividadTutorado->semana }}" required autocomplete="off" autofocus>
                                    @error('semana')
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-user @error('nombre') is-invalid @enderror" type="text" style="color: rgb(0,0,0);font-size: 18px;" placeholder="Nombre de la actividad" id="nombre" name="nombre" value="{{ $actividadTutorado->nombre }}" required autocomplete="off" autofocus>
                                @error('nombre')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                ...
                                <div class="col d-flex justify-content-center col-create-activity-tutor">
                                    <img class="img-cat" style="max-width: 100%;" src="{{ route('admin.actividad-tutorado-imagen', ['filename' => $actividadTutorado->imagen]) }}" id="imagenSalida">
                                </div>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control form-control-user @error('objetivo') is-invalid @enderror" placeholder="Objetivo" id="objetivo" name="objetivo" style="font-size: 18px;color: rgb(0,0,0);" required autocomplete="off" autofocus>{{ $actividadTutorado->objetivo }}</textarea>
                                @error('objetivo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                <textarea class="form-control form-control-user @error('instrucciones') is-invalid @enderror" placeholder="Instrucciones" id="instrucciones" name="instrucciones" style="font-size: 18px;color: rgb(0,0,0);" required autocomplete="off" autofocus>{{ $actividadTutorado->instrucciones }}</textarea>
                                @error('instrucciones')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-user @error('especialista') is-invalid @enderror" type="text" style="color: rgb(0,0,0);font-size: 18px;" placeholder="Especialista" id="especialista" name="especialista" value="{{ $actividadTutorado->especialista }}" required autocomplete="off" autofocus>
                                @error('especialista')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            @endif
                            <div class="form-group">
                                <label id="aaas" style="color: rgb(0,0,0);margin-right: 5px;">Archivo (Opcional) máximo 256M</label>
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-user @error('enlace') is-invalid @enderror" type="text" id="enlace" name="enlace" style="color: rgb(0,0,0);font-size: 18px;" placeholder="Link (Opcional)" value="{{ $actividadTutorado->enlace }}" autocomplete="off" autofocus>
                                @error('enlace')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
