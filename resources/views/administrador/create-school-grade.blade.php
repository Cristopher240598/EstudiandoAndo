            ...
            <div class="row d-flex justify-content-center">
                <div class="col col-create-activity">
                    <div class="p-5-create-activity-tutor">
                        <form class="user" method="POST" action="{{ route('admin.guardar-grado') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <input class="form-control form-control-user @error('grado') is-invalid @enderror" type="text" style="color: rgb(0,0,0);font-size: 18px;" id="grado" name="grado" placeholder="Grado escolar" value="{{ old('grado') }}" required autocomplete="off" autofocus>
                                @error('grado')
