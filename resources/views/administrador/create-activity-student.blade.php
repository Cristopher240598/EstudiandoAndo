...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header text-center">
            <h6 class="text-primary font-weight-bold m-0" style="font-size: 25px;">Agregar actividad para tutorado</h6>
        </div>
        <div class="card-body">
            <div class="row d-flex justify-content-center">
                <div class="col col-create-activity">
                    <div class="p-5-create-activity-tutor">
                        <form class="user" method="POST" action="{{ route('admin.guardar-actividad-tutorado') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col" style="padding: 0px;">
                                    <input class="form-control form-control-user @error('semana') is-invalid @enderror" type="number" style="color: rgb(0,0,0);font-size: 18px; max-width: 210px;" placeholder="Número de semana" id="semana" name="semana" min="1" max="25" value="{{ old('semana') }}" required autocomplete="off" autofocus>
                                    @error('semana')
