                ...
                <div class="container-fluid d-flex flex-column p-0">
                    <ul class="nav navbar-nav text-light" id="accordionSidebar" style="margin-top: 70px;max-width: 100px;">
                        <li class="nav-item" role="presentation" style="max-width: 100%;">
                            <a class="nav-link text-center active" href="{{ route('tutorado.actividades') }}" style="font-size: 15px;max-width: 100%;">
                ...
                <div id="content">
                    <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                        <div class="container-fluid">
                            ...
                            <a class="navbar-brand logo" data-aos="fade-right" data-aos-duration="1000" href="{{ route('tutorado.actividades') }}" style="font-family: Nunito, sans-serif;color: #0b00aa;">
                                ...
                                <li class="nav-item dropdown no-arrow" role="presentation">
                                    <div class="nav-item dropdown no-arrow">
                                        <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">
                                            ...
                                            <i class="fas fa-street-view" style="color: #086aac;font-size: 20px;"></i>
                                        </a>
