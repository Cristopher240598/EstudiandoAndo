                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        <a class="btn btn-primary btn-block text-white btn-user" role="button" style="font-size: 18px;">Iniciar sesión</a>
                                        <hr>
                                    ...
                                    <div class="text-center">
                                        @if (Route::has('register'))
                                            <a class="small subrayado" href="register.html" style="font-size: 16px; color: #4e73df; text-decoration: none;">Registrese</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
